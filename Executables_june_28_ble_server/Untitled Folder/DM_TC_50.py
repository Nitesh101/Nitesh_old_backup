...
os.chdir('/home/koripshr/Desktop/Executables_june_28_ble_server')
var=sys.argv
lis=var[1:]
#Discover_List=[] 
#Exception_list = [SystemExit, StandardError,ArithmeticError,OverflowError,FloatingPointError,ZeroDivisionError]
print "\n"
...
def call_put(index):
	...
	for number in range(loop):
		if lis[index]=="put":
"""
			CorrectUsername = "Test_Team"
			CorrectPassword = "votary"
